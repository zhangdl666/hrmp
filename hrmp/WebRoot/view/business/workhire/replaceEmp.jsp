...
<div class="container" id="bodyContainer">
	...
	<form action="business/saveReplaceEmp.action" method="post" class="form-horizontal" id="editForm">
		<s:hidden name="workSignId"></s:hidden>
		<fieldset>
        	<legend>
        		工人调换
        	</legend>
...
function showUserTree(ids,names) {
	var checkedIds = "";
	var rId = document.getElementById("workSignId").value;
	var _url = "business/selectUsersForReplaceEmp.action?workSignId=" + rId + "&&checkedIds=" + checkedIds;
